#!/bin/sh
BRANCH='lesson-5-less-and-rwd-in-magento '
...
php bin/magento setup:static-content:deploy uk_UA -f -a frontend --theme Magento/luma --jobs=4
php bin/magento setup:static-content:deploy en_US -f -a frontend --theme Viacheslav/luma --jobs=4
